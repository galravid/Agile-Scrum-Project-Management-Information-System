...
<div class="fixed-toolbar">
  <table style="height: 70px; background-color: #266C99; width: 100%; border-collapse: collapse;">
	...
	<td style="border: 1px solid #FFFFFF; width: 80px; font-size: x-large; cursor: pointer; color: #FFFFFF; text-align: center;">
      ...
      <td style="border: 1px solid #FFFFFF; font-size: x-large; cursor: pointer; color: #FFFFFF; text-align: center;">
        <a href="LocalMenuProductOwner.php" style="color: #FFFFFF; text-decoration: none;">
		תפריט מקומי</a>
      </td>
...
<form id="add-task-form">
  <input type="text" id="task-title" placeholder="כותרת" required>
  <input type="text" id="task-description" placeholder="תיאור">
  <input type="text" id="task-createddate" placeholder="תאריך יצירה (YYYY-MM-DD)">
  <input type="number" id="task-value" placeholder="ערך" required>
  <select id="task-priority">
    <option value="High">גבוה</option>
    <option value="Medium">בינוני</option>
    <option value="Low">נמוך</option>
  </select>
  <input type="text" id="task-urgency" placeholder="דחיפות">
  <input type="text" id="task-risk" placeholder="סיכון">
  <input type="text" id="task-complexity" placeholder="סיבוכיות">
  <input type="number" id="task-workload" placeholder="שעות עבודה" required>
  <input type="text" id="task-dependencies" placeholder="מטלות מחייבות קודמות (הפרד בפסיקים)">
  <select id="task-owner">
    <option value="">-- בחר בעל מוצר --</option>
  </select>
...
<button id="show-report1-btn" class="lower-button"> דו"ח ספרינט 1</button>
<button id="show-report2-btn" class="lower-button"> דו"ח ספרינט 2</button>
