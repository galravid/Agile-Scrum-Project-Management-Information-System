...
<h1>איש צוות - תפריט מקומי</h1>
<br>
  <div class="button-group">
  <button onclick="location.href='TeamMemberKanbanBoard.php'">לוח קנבן שלי</button>
  <button onclick="location.href='TeamMemberUpdateDetails.php'">עדכון פרטים</button>
  </div>
<br><br>
  <footer>
      © 2025 Taskly Team D2
