...
<title>תפריט מקומי - מנהל חברה</title>
  <style>
  .button-group {
  display: flex;
...
<h1>מנהל חברה - תפריט מקומי</h1>
<br>
  <div class="button-group">
  <button onclick="location.href='ManagerNewProduct.php'">הוספת מוצר חדש</button>
  <button onclick="location.href='ManagerDeleteProduct.php'">מחיקת מוצר</button>
  <button onclick="location.href='ReportsCompanyManager.php'">דוחות</button>
  </div>
<br><br>
  <footer>
