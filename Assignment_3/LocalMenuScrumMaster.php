...
<title>תפריט מקומי - רכז סקראם</title>
<style>
  .button-group {
  display: flex;
...
<h1>רכז סקראם - תפריט מקומי</h1>
<br>
  <div class="button-group">
  <button onclick="location.href='ScrumMasterAssociateMemberProduct.php'">שיוך עובד למוצר</button>
  <button onclick="location.href='ScrumMasterMovingMemberFromProduct.php'">העברת עובד ממוצר למוצר</button>
  <button onclick="location.href='ScrumMasterKanbanBoard.php'">עדכון לוח קנבן</button>
  <button onclick="location.href='ScrumMasterDeleteMember.php'">מחיקת איש צוות</button>
  </div>
<br><br>
  <footer>
      © 2025 Taskly Team D2
